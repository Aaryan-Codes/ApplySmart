...
export default function CoverLetterGenerator() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const formData: FormData = {
      jobDescription: (event.currentTarget.elements.namedItem(
        "jobDescription"
      ) as HTMLInputElement).value,
      role: (event.currentTarget.elements.namedItem("role") as HTMLInputElement)
        .value,
      companyName: (event.currentTarget.elements.namedItem(
        "companyName"
      ) as HTMLInputElement).value,
    };
